...
const faqs = [
  ...
  { q: "Do I need to install anything on my machine?", a: "Nothing at all. CodeOrbit runs entirely in-browser using WebContainer technology. You can write and execute Node.js, Python, and Java without touching your terminal or installing dependencies." },
